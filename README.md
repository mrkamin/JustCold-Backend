...
# 📖 JustCold Backend <a name="about-project"></a>

**JustCold Backend** is a Rails API that serves as database to the [JustCold Frontend](https://github.com/mrkamin/JustCold-Frontend) project.
...
```sh
  cd your-folder
  git clone git@github.com:mrkamin/JustCold-Backend.git
```
...
Feel free to check the [issues page](https://github.com/mrkamin/JustCold-Backend/issues).
